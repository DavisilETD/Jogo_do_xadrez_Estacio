...
void Torre(int movimento)//Recursividade.
{
    ...
    {
        Torre(movimento - 1);//Dara - 1 á váriavel movimento para que ela repita decrementando e torne a condição do bloco negativa.
        int Torre = (movimento + 1) - movimento;//Recebe o valor de movimento a cada loop e fica apenas com o valor 1.
        while(Torre > 0) //Repitira o print "movimento" vezes ja que torre vale 1 e vai ganhar 1 a cada repetição.
        {
            printf("Direita \n"); // Imprimira a jogada comforme o loop
            Torre--; //Dara - 1 á váriavel Torre para que ela pare o loop while.
        }
    }
}
...
void Bispo(int movimento)//Recursividade.
{
    if(movimento > 0)//Dará a condição do bloco.
    {
        Bispo(movimento - 1); //Dara - 1 á váriavel movimento para que ela repita decrementando e torne a condição do bloco negativa.
...
void Cavalo(int movimento)//Recursividade.
{
    if(movimento > 0)//Dará a condição do bloco.
    {
        ...
        for(Cavalo; Cavalo > 0; Cavalo--)//primeiro ante do ";" é a variável usada na condição, segundo a condição e teceiro decremento para para-lá.
        {
            printf("Cima\n");// Imprimira a jogada comforme o loop for 1
            printf("Cima\n");// Imprimira a jogada comforme o loop for 1
